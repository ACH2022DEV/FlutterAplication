  ...
  child: Column(
    ...
    children: [
      ...
      Container(
        ...
        padding:Responsive.isDesktop(context)? EdgeInsets.all(10):EdgeInsets.all(3),
        height: 50,
        child:Center(child:  Text(
        'Welcome to our marketplace!',
        style: TextStyle(
          fontSize: 20.sp,
          fontWeight: FontWeight.bold,color: Color.fromARGB(255, 19, 5, 5),
        ),
      )),),
    ...
    if(Responsive.isDesktop(context))  
      Container(
   // width: 1200,
    height: 200,padding: EdgeInsets.all(10),
        child:Row(children: [  Expanded(flex: 4,child:Text(
  ...
  style: TextStyle(
   ...
   // width: double.maxFinite,
      ...
      Image.asset(
        ...
        child:Text(
  'Notre marketplace dédiée aux agences de voyages est votre plateforme ultime pour découvrir et réserver des expériences de voyage exceptionnelles. Nous comprenons les défis auxquels les agences de voyages sont confrontées dans un monde en constante évolution, et c\'est pourquoi nous avons créé une solution complète et intuitive pour vous aider à prospérer.\n\n'
...
SizedBox(height: 2.w,),
     ...
     Container(
      ...
      child:
      Column(children: [
        Center(child: Text('Our Services',style: TextStyle(color: Color.fromARGB(255, 3, 25, 60),fontSize: 30.sp,fontWeight: FontWeight.bold),),)
       , SizedBox(height: 5.h,),
        Row(children: [
       
Expanded(
  flex:Responsive.isDesktop(context)?3:6,child:Material(
     elevation: 5,
     ...
     child:
        Container(
          ...
          width: 300, child:Column(
            ...
            children: [
 Text('Hotels',style: TextStyle(color: Color.fromARGB(255, 81, 81, 82),fontSize: 24.sp),),
            
Expanded(child: ClipRRect(
  borderRadius: BorderRadius.circular(8.0),
 
 
  child:Image.asset('../../android/app/src/assets/images/myhotel9.jpeg')
)),
     ...
     child:
        Container(
          ...
          width: 300, child:Column(children: [
            Text('Circuit',style: TextStyle(color: Color.fromARGB(255, 81, 81, 82),fontSize: 24.sp),),
Expanded(child: ClipRRect(
    borderRadius: BorderRadius.circular(8.0),
  child: Image.asset('../../android/app/src/assets/images/circuit.jpeg')
)),
  ...
  flex:Responsive.isDesktop(context)?3:6,child:Material(
     ...
     child:
        Container(
          ...
          padding: EdgeInsets.all(10 / 2),
          width: 300, child:Column(children: [
              Text('Traveling',style: TextStyle(color: Color.fromARGB(255, 81, 81, 82),fontSize: 24.sp),),
Expanded(child: ClipRRect(
  borderRadius: BorderRadius.circular(10.0),
  child:Image.asset('../../android/app/src/assets/images/fly.jpeg')
  ...
  children: [
    Text(
      'Are you interested in our marketplace?',style: TextStyle(
    color: Colors.black,
    fontSize: 18,
    fontWeight: FontWeight.normal,
  ),
...
/* Expanded(
  flex:10,child:Material(
     ...
     child: */
       ...
       Center(child: Text('Nos Services',style: TextStyle(color: Color.fromARGB(255, 3, 25, 60),fontSize: 30.sp,fontWeight: FontWeight.bold),),)
       , SizedBox(height: 5.h,),
        Container(
...
Expanded(child: ClipRRect(
    borderRadius: BorderRadius.circular(8.0),
  child: Image.asset(
    '../../android/app/src/assets/images/circuit.jpeg',
    width: double.maxFinite,
     height: 150,
  ),
)),
 ...
 /*  Expanded(
  flex:10,child:Material(
     ...
     child: */
        ...
        //  padding: EdgeInsets.all(10 / 2),
          width:  double.infinity, child:Column(children: [
              Text('Voyages',style: TextStyle(color: Color.fromARGB(255, 81, 81, 82),fontSize: 24.sp),),
Expanded(child: ClipRRect(
  borderRadius: BorderRadius.circular(10.0),
  child:Image.asset('../../android/app/src/assets/images/fly.jpeg')
)),
...
SizedBox(height: 15.h,),
  ...
  children: [
    Text(
      'Êtes-vous intéressé par notre marketplace ?',style: TextStyle(
    color: Colors.black,
    fontSize: 18,
    fontWeight: FontWeight.normal,
  ),
