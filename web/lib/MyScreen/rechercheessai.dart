...
import 'package:t3_market_place/models/hotelsSellers.dart';

// import '../models/hotel_Response.dart';
// import '../productsHotels.dart';

class searchMoteur extends StatefulWidget {
  const searchMoteur({super.key});

  @override
  State<searchMoteur> createState() => _searchState();
}
...
class _searchState extends State<searchMoteur> {
//passez data
  // end data
  ...
  Color _color2 = Color.fromARGB(255, 185, 187, 187);
...
//   final url = Uri.https('btob.3t.tn', '/getProducts', {'product': 'hotels'});
    ...
    if (response.statusCode == 200) {
      ...
      if (productsJsonList.isNotEmpty) {
        products = productsJsonLists
            .map((productJson) =>
                HotelsSellers.fromJson(json.decode(productJson)))
            .toList();
      }
      //end session
      /*  setState(() {
      ...
      child: Column(
        children: [
          ...
          if (_showHotelContainer)
                          ...
                          child: Container(
                            ...
                            child: Column(
                                ...
                                children: [
                                  Center(
                                    child: Text(
                                      "Chambres et occupation \n $NbChambres2 CHambre(s) ,$SommePersonnes2 Personne(s)",
                                      style: GoogleFonts.alike(
                                          textStyle: Theme.of(context)
                                              .textTheme
                                              .displayMedium,
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(
                                        ...
                                        style: GoogleFonts.alike(
                                            ...
                                            fontSize: 10,
                                            color:
                                                Color.fromARGB(255, 237, 3, 3)),
                                      ),
                                    ),
                                  ),
                                  //add modal
                                  if (_isModalVisible && _showHotelContainer)
                                    //add modal
            ...
            var ageFieldIndex = _selectedOption2[i];  */
                                            //end boucle
                    ...
                    Expanded(
                      ...
                      style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.all<Color>(
                            Color.fromARGB(255, 115, 110, 110)),
                        shape:
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            //  color: Color.fromARGB(255, 255, 255, 255),
                            color: Color.fromARGB(
                                255, 82, 80, 80), // Arrière-plan noir
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: DropdownButtonFormField<String>(
                              ...
                              onChanged: (String? newValue) {
                                setState(() {
                                  _selectedOptionBudget[0] = newValue!;
                                });
                              },
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            //  color: Color.fromARGB(255, 255, 255, 255),
                            color: Color.fromARGB(
                                255, 88, 84, 84), // Arrière-plan noir
